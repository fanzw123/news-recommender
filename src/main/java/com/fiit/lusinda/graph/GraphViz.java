package com.fiit.lusinda.graph;
...
public class GraphViz
{
 ...
 //  private static String TEMP_DIR = "c:/temp";	// Windows
    ...
    */
   private static String DOT = "/usr/local/graphviz-2.14/bin/dot";	// Linux
//   private static String DOT = "c:/Program Files/Graphviz2.26.3/bin/dot.exe";	// Windows
   ...
   private File writeDotSourceToFile(String str) throws java.io.IOException
   {
      ...
      try {
         ...
         OutputStreamWriter fout = new OutputStreamWriter(new FileOutputStream(temp), "UTF-8");
